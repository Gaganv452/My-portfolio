...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
      e.preventDefault();
      setloading(true);
      emailjs.send('service_x9a1382', 'template_m25ij2i', {from_name:form.name, to_name: "Gagan", from_email:form.email, to_email:"akverma1025@gmail.com", message:`message:${form.message} and Email: ${form.email}`} ,'f_VZUB9-gBXWtZ5v1' ).then(
        () => {
          setloading(false);
